	...
	void BorderPipeline::CreatePipeline()
	{
		{// Vertex shader
			bool success = Importer::CompileShaderToSPV(
				Path::Get("shaders/border_pipeline/BorderPipeline.vert.hlsl"),
				Path::Get("shaders/border_pipeline/BorderPipeline.vert.spv"),
				"vert"
			);
		...
		{// Fragment shader
			bool success = Importer::CompileShaderToSPV(
				Path::Get("shaders/border_pipeline/BorderPipeline.frag.hlsl"),
				Path::Get("shaders/border_pipeline/BorderPipeline.frag.spv"),
				"frag"
			);
			MFA_ASSERT(success == true);
		}
